...
def convertsalary (country, salary) :
 if (country == "canada"):
    ...
    if (final_salary > 64000):
            print ("You will be rich ", final_salary, " CAD")
    else:
            print ("You will be poor ", final_salary, " CAD")

 elif  (country == "us"):
    final_salary = salary * 2.5

    if (final_salary >35000) :
      print("You will be rich ", final_salary, " Pound")
    else:
      print ("You will be poor ", final_salary, " Pound")

 elif (country == "cambodia"):
    final_salary = salary * 4555
    if (final_salary >5649856) :
      print ("You will be rich ", final_salary, "cambodian riel")
    else:
      print ("You will be poor ", final_salary, "cambodian riel")

 elif (country == "united kingdon"):
      final_salary = salary * 1.2
      if (final_salary >56516) :
       print("You wiil be rich ", final_salary, "USD")
      else:
       print("You will be poor ", final_salary, "USD")
 else:
